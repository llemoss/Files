...
local function verif()
	...
	if classicTutorial == true and balloonsPopped >= 1 and toastActive == false then
			toastActive = true
			print("Iniciando tutorial")
			tutorialToast = widget.newButton{
...
local function initGame()
	...
	levelBtn.x = display.contentWidth*0.5 - 60
	levelBtn.y = display.contentHeight - 120
	welcomeText.x = display.contentWidth*0.5
	welcomeText.y = display.contentHeight*0.5 - 30
	credBtn.x = display.contentWidth*0.5 + 60
	credBtn.y = display.contentHeight - 120
	muteBtn.x = display.contentWidth*0.5 - 60
	muteBtn.y = display.contentHeight - 80
	vibrateBtn.x = display.contentWidth*0.5 + 60
	vibrateBtn.y = display.contentHeight - 80
	touch = 1
end
